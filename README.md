...
```bash
git clone 
https://github.com/ahlamkhan903-pixel/CodeAlpha_NetworkSniffer.git
...
```
        ...
        CodeAlpha — Basic Network Sniffer                       Cybersecurity Internship Task 1       
...
- **LinkedIn:** https://www.linkedin.com/in/ahlam-khan-4224682ba/
- **GitHub:** https://github.com/ahlamkhan903-pixel/CodeAlpha_NetworkSniffer
